...
- **Don't hand-edit the generated data** in `allSheetTraits`/`allColTraits`/`valueTraits` (`src/02_generatedTraits/`) — regenerate from the spreadsheet instead, per README.
