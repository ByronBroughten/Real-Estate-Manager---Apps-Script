function testMonthlyRentUpdate() {
  ...
  return asU.batchUpdateRanges(rangeData, spreadsheets.tenantTracker.id);
}
...
function getRecurringPriceUpdateRangeData(genToRangeNames) {
  ...
  return makeRangeData(gro, ["priceCurrent", "dateCurrent"]);
}
...
function testGetOneTimePriceUpdateRangeData() {
