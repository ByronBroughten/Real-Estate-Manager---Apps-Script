...
- **`.clasp.json`** and `appsscript.json` for your Apps Script project, with the Sheets advanced service enabled, and a `realEstateSpreadsheetId` script property set to your spreadsheet's ID.
