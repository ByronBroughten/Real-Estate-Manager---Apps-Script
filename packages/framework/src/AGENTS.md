...
- **Read the general [style doc](../../../config/docs/style.md), then the framework's [docs/style.md](../docs/style.md), before editing TypeScript here.** Words: [docs/vocabulary.md](../docs/vocabulary.md). Mechanics: the [`docs/architecture.md`](../docs/architecture.md) index.
