...
- **`npm run dev:chore <name> -- --send` has a standing yes; `app:chore … --send` needs a yes naming that chore** ([the app's chore rules](../../../real-estate/src/chores/AGENTS.md)). One never covers the other.
