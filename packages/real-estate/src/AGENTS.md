...
- **The words are [CONTEXT.md](../CONTEXT.md)'s**, after the framework's. Code shape: the general [style doc](../../../config/docs/style.md), then the framework's [rules](../../framework/docs/style.md).
