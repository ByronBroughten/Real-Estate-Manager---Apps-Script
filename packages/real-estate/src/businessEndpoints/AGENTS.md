...
- **Framework code comes only from `@byronbroughten/sheets-framework`, and in tests also from `@byronbroughten/sheets-framework/testing`**: see [`src/AGENTS.md`](../../../framework/src/AGENTS.md).
...
- The ledger's build behavior: [`docs/occupancy-ledger.md`](../../../../docs/occupancy-ledger.md). Dispatch and run states: [`docs/architecture/endpoint-dispatch.md`](../../../framework/docs/architecture/endpoint-dispatch.md).
