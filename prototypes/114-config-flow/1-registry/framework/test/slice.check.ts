...
import "./registerFixture";
import { Api } from "../Api";

const api = new Api({ widget: (a) => a.sheet("widget").setValue(0, "run", false) }, {});
...
// @ts-expect-error: no real-estate sheet exists in the framework's program
api.sheet("unit");
