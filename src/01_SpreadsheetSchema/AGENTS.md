...
- **Regenerate the four files in `generated/` together with `npm run gen:configs`, never a subset**, and never edit their data by hand, floor entries included: fix the live tab or the seed.
