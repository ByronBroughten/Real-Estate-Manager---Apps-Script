...
export const columnConfigs = makeColumnConfigs({
  spreadsheetControls: {
    ...
    updateConfigRowsTimeLastRan: {
      columnId: "c:sct:9SE5ZSP",
      header: "Update config rows, time last ran",
      valueName: "string",
      isFormula: false,
      emptyAllowed: false,
      customDefaultValue: null,
    },
    appendSheetAndColumnConfigRowsLastRanSucceeded: {
      columnId: "c:sct:W7W53RR",
      header: "Append sheet and column config rows, last ran succeeded",
      valueName: "boolean",
      isFormula: false,
      emptyAllowed: false,
      customDefaultValue: null,
    },
    appendSheetAndColumnConfigRowsErrorMessage: {
      columnId: "c:sct:M2bLafa",
      header: "Append sheet and column config rows, error message",
      valueName: "string",
      isFormula: false,
      emptyAllowed: false,
      customDefaultValue: null,
