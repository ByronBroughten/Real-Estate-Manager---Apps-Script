...
const literalValues = {
  ...
  deductibleAmount: `=IFS(SR("Tax adjust")="", SR("Amount"), SR("Tax adjust")="Minus primary space", ROW_MATCH(propertyYear[Not primary space], propertyYear[Name], "Property year name")*SR("Amount"), SR("Tax adjust")="Primary residence", 0, SR("Tax adjust")="Half primary residence", SR("Amount")/2, SR("Tax adjust")="Minus primary time space", ROW_MATCH(propertyYear[Not primary space], propertyYear[Name], "Property year name")*ROW_MATCH(propertyYear[Primary time owned], propertyYear[Name], "Property year name") *SR("Amount")+ROW_MATCH(propertyYear[Not primary time owned], propertyYear[Name], "Property year name")*SR("Amount"))`,
  ...
  hhIdFromScId: `=ROW_MATCH(subsidyAgreement[Household ID], subsidyAgreement[ID], "Subsidy agreement ID")`,
  ...
  subsidyAgreementIdFromNameOp: `=ROW_MATCH_OR_BLANK(subsidyAgreement[ID], subsidyAgreement[Name], "Subsidy agreement name")`,
  ...
  unitIdFromBHLhhLastRanOp: `=ROW_MATCH_OR_BLANK(household[Unit ID], household[ID], "BHL household ID last ran")`,
  ...
  subsidyContractNameFromId: `=ROW_MATCH(subsidyAgreement[Name], subsidyAgreement[ID], "Subsidy agreement ID")`,
