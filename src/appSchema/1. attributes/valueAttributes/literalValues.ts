...
const literalValues = {
  ...
  hhIdFromScId: `=ROW_MATCH(subsidyContract[Household ID], subsidyContract[ID], "Subsidy contract ID")`,
  ...
  subsidyContractIdFromNameOp: `=ROW_MATCH_OR_BLANK(subsidyContract[ID], subsidyContract[Name], "Subsidy contract name")`,
