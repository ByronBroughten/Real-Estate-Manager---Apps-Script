...
const literalValues = {
  ...
  hhIdFromName: `=ROW_MATCH(household[ID], household[Name], "Household name")`,
  unitNameFromHouseholdId: `=ROW_MATCH(household[Unit name], household[ID], "Household ID")`,
  unitNameFromId: `=ROW_MATCH(unit[Name], unit[ID], "Unit ID")`,
  unitIdFromName: `=ROW_MATCH(unit[ID], unit[Name], "Unit name")`,
