...
export const allVarbAttributes = makeSchemaStructure(
  {} as SectionVarbsBase,
  {
    ...
    household: {
      ...
      rentChangeDateLast: vS.gen("date", "Last rent change date"),
      rentChangeDateNext: vS.gen("date", "Next rent change date"),
