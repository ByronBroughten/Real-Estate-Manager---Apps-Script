...
export const buildDevFixtures: Chore = {
  ...
  action: (ss, { spreadsheetId }) => {
    ...
    return new DevFixtureBuilder(ss.spreadsheetNamedProps).ensureFixtures();
  },
};
